...
const CASES = [
  ...
  { tag: true, name: "outbound call where the client asks for the attorney",
    text: `Paralegal called the client to collect his employer information. During the call the client said he needs to talk to the attorney directly about whether to accept the offer, and asked the attorney to call him.` },
